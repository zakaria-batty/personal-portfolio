  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <select name="category" class="custom-select">
        ...
        <option value="pe">Experience</option>
      </select></div>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name="year" class="form-control" id="website" placeholder="2020-2021" required>
    </div>
      ...
      <tr>
        <div class="modal fade" id="modal<?= $data2['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <td>
            ...
            <a href="php/uresume.php?del=<?= $data2['id'] ?>">
