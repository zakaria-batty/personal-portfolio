...
<form method="post" action="php/uabout.php">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="Age" value="<?= $data['Age'] ?>" class="form-control" id="Age" placeholder="22">
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="Degree" value="<?= $data['Degree'] ?>" class="form-control" id="Degree" placeholder="Degree">
    </div>
    <div class="form-group col-md-6">
      <label for="website">Phone</label>
      <input type="text" name="Phone" value="<?= $data['Phone'] ?>" class="form-control" id="Phone" placeholder="+212687904633">
    </div>
    <div class="form-group col-md-6">
      <label for="website">Email</label>
      <input type="text" name="Email" value="<?= $data['Email'] ?>" class="form-control" id="Email" placeholder="zbatty1297@gmail.com">
    </div>
    <div class="form-group col-md-6">
      <label for="website">City</label>
      <input type="text" name="City" value="<?= $data['City'] ?>" class="form-control" id="City" placeholder="Youssoufia, maroc">
    </div>
  </div>
