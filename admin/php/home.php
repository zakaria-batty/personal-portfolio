...
<form class="formule" method="post" action="php/uhome.php" enctype="multipart/form-data">
  <div class="form-row">
    <div class="form-group col-md-6">
      <img src="../dist/img/<?=$data['profilepic'] ?>" class="oo img-thumbnail"><br>
    ...
    <div class="form-group col-md-6">
      <img src="../dist/img/<?=$data['homewallpaper'] ?>" class="oo img-thumbnail">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="email" name="email" value="<?= $data['emailid'] ?>" class="form-control" id="email" placeholder="zbatty1297@gmail.com">
    </div>
    <div class="form-group col-md-6">
